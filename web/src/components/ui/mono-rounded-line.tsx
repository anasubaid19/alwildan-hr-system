...
interface MonoRoundedLineChartProps {
  theme?: "dark" | "light"
  compact?: boolean
  /** Data titik chart; `secondary` opsional (garis baseline putus-putus). */
  data?: LinePoint[]
  /** Judul kecil di kiri atas kartu. */
  title?: string
  /** Satuan nilai utama, mis. "rupiah". */
  unit?: string
  /** Format tampilan nilai (tooltip, header, footer). */
...
export function MonoRoundedLineChart({
  ...
  const points = data && data.length > 0 ? data : MONO_LINE_DATA
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        {points.some((p) => typeof p.secondary === "number") && (
          <div
